...
const Projects: React.FunctionComponent = () => {
  ...
  return (
    <Paper id="projects" className={classes.homeContainer} elevation={0}>
        ...
        <Grid item xs={12} sm={6}>
          <Typography variant="h6" className={classes.homeContent}>
            ...
            <Grid item>
              ...
              constantly growing. I'm currently working my way into contributing
              to{" "}
              <LinkTo
          ...
          <Typography variant="h6" className={classes.homeContent}>
            ...
            <Grid item>
              ...
              <Grid item>
                ...
                <LinkTo to="https://material-ui.com/" title="Material UI" /> and{" "}
                <LinkTo to="https://reactjs.org/" title="React.js" /> in order
                to work on my creative skills building a personal website from.
              </Grid>
            </Grid>
          </Typography>
        </Grid>
